...
def split_file(input_filename, n):
    ...
    for i in range(0, len(lines), 2):
        if i + 1 < len(lines):
            ...
            output_filename = f"/data/zec022/phastsim_datasets/dataset_{n}/seqs/{title[1:]}.fa"
...
split_file(f"/data/zec022/phastsim_datasets/dataset_{args.dataset_size}/sars-cov-2_simulation_output.fasta", args.dataset_size)
# print("Changing distance matrix")
# change_directory(os.path.expanduser('~/phylo-accel/test/phastsim_dataset'))
# replace_first_line("distance_matrix.phy", "512 2") # modify this
