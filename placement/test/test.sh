...
do
    ...
    # ./mash-placement -f /data/swalia/dipper/alisim/datasets/10000/len_10000_leaves_10000.unaligned.fa -i r -o t > tree.nwk
    ./mash-placement -f /data/swalia/dipper/alisim/datasets/10000/len_10000_leaves_10000.dist -i d -o t > tree.nwk
    cd ~/MAPLE
    ~/pypy3.10-v7.3.16-linux64/bin/pypy3 MAPLEv0.3.6.py --inputTree ~/placement/test/tree.nwk --inputRFtrees /data/swalia/dipper/alisim/trees/nleaves10000_noramalBranches.treefile --output ~/temp.txt --overwrite
    cat ~/temp.txt_RFdistances.txt 
